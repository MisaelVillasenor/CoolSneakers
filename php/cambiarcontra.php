...
if (isset($_POST['enviar'])) { 
    if (strlen($_POST['correo']) >= 1 && strlen($_POST['password'])) {
      ...
      $consulta=("SELECT id, correo, password FROM registro WHERE correo='$correo' AND password='$password' ");
...
<body>
  ...
  <section id="form-width">
    ...
    <form action="login.php" id="form-container" method="POST">
      <div class="row">

        <!-- form img -->
        <div class="col-lg-6 col-md-12 col-sm-12">
          <figure class="w-100 img-form">
            <img src="..//img/contra2.png">
          </figure>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          ...
          <h4 class="text-center text-uppercase anton">CAMBIAR CONTRASEÑA</h4>
          <hr>

          <!-- inputs -->
          <div class="inputs-form form-group">
          <label for="email_form" class="ubuntu">Introduzca su correo Electrónico:</label>
            <input type="email" placeholder="Escriba su email" name="correo" id="email_form"
              class="form-control mb-4" required>

          <label for="email_form" class="ubuntu">Introduzca su nueva contraseña:</label>
            <br>
          <label for="email_form" class="ubuntu"></label>
            <input type="password" placeholder="Escriba su contraseña" name="password" id="email_form"
              class="form-control mb-4" required>
...
<?php
    ...
    <script>
        function alerta(){
            swal({
                title: "Se cambió su contraseña exitosamente",
