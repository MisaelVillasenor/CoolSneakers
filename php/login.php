    ...
    <form action="login.php" id="form-container" method="POST">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          ...
          <h4 class="text-center text-uppercase anton">INICIAR SESIÓN</h4>
          <hr>
          ...
          <div class="inputs-form form-group">
            ...
            <label for="" class="ubuntu">¿No tienes una cuenta?
              <abbr title="Crea una nueva cuenta en nuestra plataforma">
                <a href="registrar.php"> Registrate aquí</a>
              </abbr>
            </label>
